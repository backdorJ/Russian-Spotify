...
namespace RussianSpotift.API.Data.PostgreSQL.Migrations
{
    ...
    [Migration("20240401111222_Reconfiguring Song File Album [Added image file]")]
    partial class ReconfiguringSongFileAlbumAddedimagefile
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RussianSpotify.API.Core.Entities.Album", b =>
                {
                    ...
                    b.HasOne("RussianSpotify.API.Core.Entities.File", "Image")
                        .WithOne("Album")
                        .HasForeignKey("RussianSpotify.API.Core.Entities.Album", "ImageId");
