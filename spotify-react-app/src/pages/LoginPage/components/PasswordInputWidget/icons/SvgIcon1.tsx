function SvgIcon1({ className }: { className: string }) {
  return (
    <div className={className}>
      <svg fill="none" viewBox="0 0 24.875 22.0241" xmlns="http://www.w3.org/2000/svg" x="0" y="0">
        <defs>
          <clipPath id="clip4_0_878" xmlns="http://www.w3.org/2000/svg">
            <rect height="24" width="24" fill="white" transform="translate(0.4375, -0.6050000000000182)" />
          </clipPath>
        </defs>
        <g id="Frame_19" clipPath="url(#clip4_0_878)" xmlns="http://www.w3.org/2000/svg" data-node-id="0:935">
          <g id="Frame_20" data-node-id="0:936">
            <path
              id="Vector_4"
              ...
              data-node-id="0:937"
            />
            <path id="Vector_5" d="M18.2805,10.124c-0.328,2.755 -2.494,4.956 -5.24,5.24z" fill="currentColor" data-node-id="0:938" />
          </g>
        </g>
      </svg>
    </div>
